...
// OpenGL/GLU removed: rendering is now a software framebuffer (see PORTING.md).
#include <iostream>
#include <math.h>
#include <algorithm>
#include <vector>
...
#include <random>
#include <string>
// Sleep() is a Win32 API. Provide a portable equivalent everywhere else so the
// game builds on Linux/macOS/Emscripten (the only thing windows.h was used for).
#if defined(_WIN32)
#include <windows.h>
#elif !defined(Sleep)
#include <unistd.h>
