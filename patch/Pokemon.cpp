...
#include "main.h"
#include "Database.h"
#include <cstdio>   // snprintf (portable replacement for MSVC _itoa)
...

{
	*this = (*Database::GetPkmn(ID));
	...
	snprintf(buf1, sizeof(buf1), "%d", _actHP); snprintf(buf2, sizeof(buf2), "%d", _HP);
	...
	snprintf(buf1, sizeof(buf1), "%d", _Lvl); b = "N.";
